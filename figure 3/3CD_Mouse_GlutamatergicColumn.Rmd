...
obj.ctx <- readRDS(paste0(dir.list$spatial$seurat$processed, "mouse_stereoseq_labeled.rds"))
...
names(colors.glutamatergic) <- c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT", "L6b")
...
# Non-neuronal colors (6 subclasses) — distinct, not green-dominant
...
glut.subclasses <- c("L2/3", "L4", "L5IT", "L5NP", "L5PT", "L6IT", "L6CT", "L6b")
...
print(p)
SavePNGandSVG(p, dir.list$fig3$plots, "3C_Mouse-ColumnSubclassGlutamatergic-SpatialDimPlot")
```
...
print(p)
SavePNGandSVG(p, dir.list$fig3$plots, "3D_Mouse-ColumnSubclassGlutamatergic-Density")
```
